...
const ownerFamily = { id: 'f1', name: 'Garcia', bio: 'caring for three teens', kidCount: 3, isOwner: true, updatedAt: '2026-05-17' };
const otherFamily = { id: 'f2', name: 'Lee',    bio: 'family of four',        kidCount: 2, isOwner: false, updatedAt: '2026-05-17' };
