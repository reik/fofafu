...
- [x] Tailwind tokens wired from `fofafu_vault/standards/design-system.md` (warm surface, brand-primary CTA pill).
...
- Tailwind 3 + design tokens from `fofafu_vault/standards/design-system.md`
...
Visual follows `fofafu_vault/standards/design-system.md` v0 token system. Single-column, ≤ 480px content, centered. CTAs are pill on brand-primary.
